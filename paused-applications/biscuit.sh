...
readonly temp_folder=biscuit_temp
readonly extr_folder=biscuit_extr
readonly package_name="biscuit.tar.gz"
readonly package_name_regex="^biscuit-linux_386.tgz$"
readonly github_owner=primait
readonly github_repo=biscuit
...
chmod +x $extr_folder_path/biscuit
sudo mv -f "$extr_folder_path/biscuit" /usr/local/bin/biscuit
